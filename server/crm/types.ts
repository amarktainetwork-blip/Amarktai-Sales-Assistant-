...
export type CrmAdapter = {
  ...
  syncContacts: (input: {
    ...
    secret: ConnectionSecretPayload;
    cursor?: string;
  }) => Promise<{ records: NormalizedContact[]; cursor?: string }>;
  /** Optional bounded fast path for recently-added/changed contacts. Never implies a full reconciliation. */
  syncRecentContacts?: (input: {
    connection: AdapterConnection;
    secret: ConnectionSecretPayload;
  ...
  syncCompanies: (input: {
    ...
    secret: ConnectionSecretPayload;
    cursor?: string;
  }) => Promise<{ records: NormalizedCompany[]; cursor?: string }>;
  ...
  syncTasks: (input: {
    ...
    secret: ConnectionSecretPayload;
    cursor?: string;
  }) => Promise<{ records: NormalizedTask[]; cursor?: string }>;
  syncActivities: (input: {
    connection: AdapterConnection;
    secret: ConnectionSecretPayload;
    cursor?: string;
  }) => Promise<{ records: NormalizedActivity[]; cursor?: string }>;
  ...
  listPipelines: (input: {
    ...
    Array<{
      externalId: string;
      label: string;
      stages: Array<{ externalId: string; label: string }>;
    }>
  >;
  healthCheck: (input: {
    connection: AdapterConnection;
