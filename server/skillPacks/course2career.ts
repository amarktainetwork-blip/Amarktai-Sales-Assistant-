...
export const COURSE2CAREER_SKILL_PACK: readonly OrganisationSkillSeed[] = [
  ...
  {
    key: "invalid-contact-complete",
    title: "Invalid Contact — complete",
    definition: definition(
      "Handle an invalid number over two days: request corrected details, wait one full day, re-check responses, then prepare permission-to-close and the correct Lost outcome only when no correction exists.",
      "A real Day 1 call proves the current phone number is invalid.",
      [
        ...readContext,
        {
        ...
        {
          id: "prepare-invalid-contact-note",
          action: "prepare_note",
          label: "Prepare the supplied exact invalid-contact Day 1 note",
        },
        {
          id: "prepare-response-check",
          action: "prepare_task",
          label: "Prepare a response check after one full day",
          timingRule: "P1D",
        },
        {
          id: "prepare-permission-to-close",
          action: "prepare_email",
          label: "If no correction exists, prepare Consultant Contact Email / Permission to Close Your File",
          templateKey: "consultant-contact-email-permission-to-close",
        },
        {
          id: "prepare-programme-close-file",
          action: "prepare_sms",
          label: "Prepare the Cyber, Data, PM or IT Close File mapping",
          templateKey: "close-file-by-programme",
        },
        {
          id: "prepare-invalid-lost",
          action: "prepare_opportunity_update",
          label: "Prepare Lost – No Show/No Response, Status Lost, reason Invalid Contact Details",
        },
        {
          id: "prepare-invalid-closed-lost-programme",
          action: "prepare_contact_update",
          label: "Prepare the Closed Lost field with the original programme so the correct sequence begins",
        },
        {
          id: "complete-invalid-task",
          action: "complete_task_after_review",
          label: "Complete the task only after reviewed communications and readback",
          requiredEvidence: [
            "response_check",
            "activity_readback",
            "opportunity_readback",
      ...
      ],
      {
        ...
        decisionRules: [
          "Never close the lead on the day the invalid number is discovered",
          "Wait at least one full day after the Invalid Phone Number email",
          "A corrected number or any genuine response cancels the close-file path and returns the lead to normal First Call handling",
          "No response after the full-day wait permits the permission-to-close and programme-specific close-file bundle",
          "The final task may close only after required communications have verified success",
        ],
        requiredMappings: [
          "Consultant Contact Emails / Invalid Phone Number",
          "Consultant Contact Email / Permission to Close Your File",
          "Consultant Contact Text / Close File Cyber",
          "Consultant Contact Text / Close File Data",
          "Consultant Contact Text / Close File Project Management",
          "General Close File template",
          "Closed Lost programme field values",
        ],
        parameters: {
          specialSmsDestinationOverride: "+44 7428 000560",
          overrideScope: "Course2Career organisation configuration only",
          dayOneTaskNote: "Attempted to call the lead, but the telephone number provided was invalid. Invalid Phone Number email sent. Awaiting a response with the correct contact details.",
          finalTaskNote: "Telephone number confirmed as invalid. Invalid Phone Number email sent and no response received after one day. Permission to Close Your File email and programme-specific close-file text sent. Enquiry closed due to invalid contact details.",
          lostStage: "Lost – No Show/No Response",
          lostStatus: "Lost",
          lostReason: "Invalid Contact Details",
        },
      }
    ),
  },
