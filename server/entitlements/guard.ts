...
export function assertEntitledFeature(entitlement: OrganisationEntitlement | null | undefined, feature: string) {
...
export function assertEntitlementLimit(entitlement: OrganisationEntitlement | null | undefined, limitKey: string, currentUsage: number) {
