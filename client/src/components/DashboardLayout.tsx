...
import { Activity, Bot, Cable, CalendarDays, CheckCircle2, Gauge, Headphones, LayoutDashboard, LibraryBig, LockKeyhole, LogOut, MailCheck, Settings2, Users, Workflow, Zap } from "lucide-react";
...
const salespersonMenu: NavItem[] = [
  { icon: CalendarDays, label: "Today", path: "/today" },
  { icon: Zap, label: "Automate work", path: "/automation" },
  { icon: Activity, label: "My work", path: "/workspace" },
  { icon: Headphones, label: "Live call companion", path: "/calls" },
...
const managementMenu: NavItem[] = [
  ...
  { icon: Zap, label: "Sales automation", path: "/automation" },
  { icon: CalendarDays, label: "Today", path: "/today" },
  { icon: Activity, label: "Review command centre", path: "/workspace" },
  { icon: Workflow, label: "Playbooks", path: "/workflows" },
  { icon: Headphones, label: "Live call companion", path: "/calls" },
  { icon: Users, label: "Team members", path: "/team/manage" },
  { icon: Cable, label: "Connected systems", path: "/connections" },
  { icon: Gauge, label: "Automation & targets", path: "/admin-controls" },
  { icon: Settings2, label: "Company setup", path: "/company-setup" },
];
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const menuItems = organisation.data?.role === "owner" || organisation.data?.role === "manager" || user?.role === "admin" ? managementMenu : salespersonMenu;
