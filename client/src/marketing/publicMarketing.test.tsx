...
const pages = [
  ["/", HomePage, "A clearer sales day."],
  ["/how-it-works", HowItWorksPage, "Set up the business once."],
  ["/pricing", Pricing, "PRICING IN SOUTH AFRICAN RAND"],
  ["/about", AboutPage, "ABOUT AMARKTAI NETWORK"],
  ["/contact", ContactPage, "CONTACT AMARKTAI NETWORK"],
] as const;

function render(pathname: string, Component: React.ComponentType) {
  return renderToStaticMarkup(<Router ssrPath={pathname}><Component /></Router>);
}
