...
const salesLoop = [
  ["01", "Connect what you already use", "Keep the CRM and business systems your team already trusts. AmarktAI learns the approved company context and works around those sources instead of asking you to replace them."],
  ["02", "Run the day from Today", "Replies, due work, overdue follow-ups, new leads and scheduled calls become one ordered personal queue with the right customer context attached."],
  ["03", "Stay in the conversation", "Prepare before the call and use consented live assistance when it helps while the salesperson stays focused on the customer, not on admin."],
  ["04", "Let AmarktAI prepare the follow-through", "Capture the real outcome, prepare the next admin and review consequential actions before anything customer-facing or external is allowed to run."],
] as const;
    ...
    <MarketingLayout>
      <section className="amk-hero">
        <div className="amk-shell amk-hero__grid">
          <div className="amk-hero__copy">
            <p className="amk-eyebrow">THE SALES ASSISTANT THAT WORKS AROUND YOUR CRM</p>
            <h1>
              Get hours of your sales day back.
              <span>Know who needs you, what matters and what happens next.</span>
            </h1>
            <p className="amk-lead">
              <BrandName /> connects to the CRM your business already uses and turns live customer activity, tasks, replies, company knowledge and call context into one guided sales day — less admin, fewer missed follow-ups and more time selling and helping customers.
            </p>
            ...
            <div className="amk-proofline" aria-label="Product benefits">
              <span><Check size={15} /> Not another CRM</span>
              <span><Check size={15} /> Works around the system you already use</span>
              <span><Check size={15} /> Important actions stay reviewable</span>
            </div>
          </div>
      ...
      <section className="amk-benefit-band">
        <div className="amk-shell amk-benefit-band__grid">
          <div><strong>Keep the CRM you already trust</strong><span>AmarktAI sits above it instead of replacing it.</span></div>
          <div><strong>Get time back every day</strong><span>Preparation, reminders and follow-through in one flow.</span></div>
          <div><strong>Never rebuild the customer story</strong><span>Context follows you from Today to the call to Review.</span></div>
        </div>
      </section>
      ...
      <section className="amk-section amk-section--light">
        <div className="amk-shell">
          <div className="amk-section__head amk-section__head--center">
            <p className="amk-eyebrow">AN ASSISTANT, NOT ANOTHER SYSTEM TO MANAGE</p>
            <h2>Your salesperson should spend the day selling — not rebuilding context and chasing admin.</h2>
            <p>The useful information is already spread across the CRM, customer history, inbox and business knowledge. <BrandName /> pulls the right pieces together at the moment they are needed and keeps the next step visible.</p>
          </div>
      ...
      <section className="amk-section amk-section--white">
        <div className="amk-shell">
          <div className="amk-section__head">
            <div>
              <p className="amk-eyebrow">ONE ASSISTANT ACROSS THE ENTIRE SALES DAY</p>
              <h2>From the first priority to the finished follow-up.</h2>
            </div>
            <p>AmarktAI stays with the salesperson from deciding who needs attention, through customer context and the call, to the reviewed next action — instead of becoming another dashboard, another chat box or another place to copy information into.</p>
          </div>
      ...
      <section className="amk-section amk-section--light">
        <div className="amk-shell amk-split">
          ...
          <div className="amk-split__copy">
            ...
            <h2>Teach the business once. Give every salesperson an assistant that knows how they work.</h2>
            <p>Managers approve shared company knowledge once. Each salesperson keeps their own login, CRM identity, mailbox and customer context while AmarktAI keeps their day focused on the work that actually needs them.</p>
      ...
      <section className="amk-final-cta">
        <div className="amk-shell amk-final-cta__inner">
          <div>
            ...
            <p>Start with one salesperson, or show us the systems and sales process your team already uses.</p>
          </div>
          <div className="amk-actions">
