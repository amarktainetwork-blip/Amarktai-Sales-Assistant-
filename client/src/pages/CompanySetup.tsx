      ...
      >
        ...
        >
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-2 max-w-3xl text-sm leading-6 text-[#66758A]">
                  ...
                  that part. Then confirm the shared business knowledge your
                  team can trust.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-5">
              ...
              <section className="rounded-3xl border border-[#BFD1EE] bg-[#F4F8FF] p-5 shadow-sm sm:p-6">
                ...
                <p className="mt-2 text-sm leading-6 text-[#66758A]">
                  These are suggestions based on website prominence and depth,
                  not a claim about sales volume.
                </p>
          ...
          <section className="rounded-3xl border border-[#DCE4EE] bg-white p-5 shadow-sm sm:p-6">
            ...
            <p className="mt-2 text-sm leading-6 text-[#66758A]">
              Management confirmation shares the approved facts and selected
              sales focus with the team. It never asks for CRM credentials.
            </p>
