...
type Provider = "genie" | "hubspot" | "salesforce" | "pipedrive" | "zoho" | "custom_browser" | "csv_import";
...
const providerNames: Record<Provider, string> = { genie: "Genie", hubspot: "HubSpot", salesforce: "Salesforce", pipedrive: "Pipedrive", zoho: "Zoho CRM", custom_browser: "Other browser CRM", csv_import: "Import / export" };
