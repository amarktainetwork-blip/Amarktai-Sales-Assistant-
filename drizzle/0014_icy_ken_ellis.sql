...
ALTER TABLE `organisationCompliancePolicies` ADD CONSTRAINT `organisationCompliancePolicies_organisationId_organisations_id_fk` FOREIGN KEY (`organisationId`) REFERENCES `organisations`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
