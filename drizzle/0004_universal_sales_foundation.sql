...
ALTER TABLE `connectorVerificationRuns` ADD CONSTRAINT `connectorVerificationRuns_connectedSystemId_connectedSystems_id_fk` FOREIGN KEY (`connectedSystemId`) REFERENCES `connectedSystems`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
