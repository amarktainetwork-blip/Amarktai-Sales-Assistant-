...
ALTER TABLE `connectorWebhookReceipts` ADD CONSTRAINT `connector_webhook_receipts_connected_system_fk` FOREIGN KEY (`connectedSystemId`) REFERENCES `connectedSystems`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `operationalAlertDeliveries` ADD CONSTRAINT `operational_alert_deliveries_event_fk` FOREIGN KEY (`operationalEventId`) REFERENCES `operationalEvents`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `operationalAlertDeliveries` ADD CONSTRAINT `operational_alert_deliveries_rule_fk` FOREIGN KEY (`alertRuleId`) REFERENCES `operationalAlertRules`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
